            ...
            <div class="col-md-8">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        ...
                        <button @click.prevent="addToCart(produk.id, calculateDiscount(produk), produk.berat)" class="btn btn-primary btn-lg btn-block"><i class="fa fa-shopping-cart"></i> TAMBAH KE KERANJANG</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        setup() {
            ...
            onMounted(() => {
                store.dispatch('produk/getDetailProduct',
                    route.params.slug)
            })
             ...
             * function addToCart
             */
            function addToCart(produk_id, harga, berat) {
