                        ...
                        */
                        ...
                        Api.get('/keranjang')
                            .then(response => {
                                ...
                                commit('keranjang/GET_CART', response.data.cart, { root: true }) // <-- kita tambahkan root menjadi true, karena beda modulue
                            })
                        ...
                        Api.get('/keranjang/total')
                            .then(response => {
                                ...
                                commit('keranjang/TOTAL_CART', response.data.total, { root: true }) // <-- kita tambahkan root menjadi true, karena beda modulue
